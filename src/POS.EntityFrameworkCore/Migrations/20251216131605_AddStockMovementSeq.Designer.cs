...
namespace POS.Migrations
{
    ...
    [Migration("20251216131605_AddStockMovementSeq")]
    partial class AddStockMovementSeq
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Branches.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("POS.ProductTypes.ProductType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("POS.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("POS.StockMovement.StockMovementDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("StockMovementHeaderId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StockMovementHeaderId");

                    b.ToTable("AppStockMovementDetails", (string)null);
                });

            modelBuilder.Entity("POS.StockMovement.StockMovementHeader", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long?>("StockMovementSeq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long?>("StockMovementSeq"));
                    ...
                    b.HasIndex("StockMovementNo")
                        .IsUnique();

                    b.ToTable("AppStockMovementHeaders", (string)null);
                });
            ...
            modelBuilder.Entity("POS.Products.Product", b =>
                {
                    ...
                    b.HasOne("POS.ProductTypes.ProductType", "ProductType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("POS.StockMovement.StockMovementDetail", b =>
                {
                    b.HasOne("POS.Products.Product", "Product")
                        .WithMany("StockMovementDetails")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POS.StockMovement.StockMovementHeader", "StockMovementHeader")
                        .WithMany("StockMovementDetails")
                        .HasForeignKey("StockMovementHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("StockMovementHeader");
                });

            modelBuilder.Entity("POS.StockMovement.StockMovementHeader", b =>
                {
                    b.HasOne("POS.Branches.Branch", "Branch")
                        .WithMany()
