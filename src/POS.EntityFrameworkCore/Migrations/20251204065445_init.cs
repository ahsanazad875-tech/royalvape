        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    VatPerc = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0m),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppBranches_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppBranches_AbpUsers_LastModifierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeDesc = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProductTypes_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppProductTypes_AbpUsers_LastModifierId",
                        column: x => x.LastModifierId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "AppStockMovementHeaders",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StockMovementNo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    StockMovementType = table.Column<int>(type: "integer", nullable: false),
                    BusinessPartnerName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    Description = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    AmountExclVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    AmountVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    AmountInclVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStockMovementHeaders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppStockMovementHeaders_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppStockMovementHeaders_AbpUsers_LastModifierId",
                        column: x => x.LastModifierId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppStockMovementHeaders_AppBranches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductNo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ProductName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    ProductDesc = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    ImageUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    BuyingUnitPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                    SellingUnitPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppProducts_AbpUsers_LastModifierId",
                        column: x => x.LastModifierId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AppStockMovementDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StockMovementHeaderId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    UoM = table.Column<int>(type: "integer", maxLength: 32, nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    AmountExclVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    AmountVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    AmountInclVat = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStockMovementDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppStockMovementDetails_AppProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "AppProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppStockMovementDetails_AppStockMovementHeaders_StockMoveme~",
                        column: x => x.StockMovementHeaderId,
                        principalTable: "AppStockMovementHeaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBranches_CreatorId",
                table: "AppBranches",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBranches_LastModifierId",
                table: "AppBranches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_LastModifierId",
                table: "AppProducts",
                column: "LastModifierId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_ProductNo",
                table: "AppProducts",
                column: "ProductNo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppProductTypes_CreatorId",
                table: "AppProductTypes",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductTypes_LastModifierId",
                table: "AppProductTypes",
                column: "LastModifierId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductTypes_Type",
                table: "AppProductTypes",
                column: "Type",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementDetails_ProductId",
                table: "AppStockMovementDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementDetails_StockMovementHeaderId",
                table: "AppStockMovementDetails",
                column: "StockMovementHeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementHeaders_BranchId",
                table: "AppStockMovementHeaders",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementHeaders_CreatorId",
                table: "AppStockMovementHeaders",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementHeaders_LastModifierId",
                table: "AppStockMovementHeaders",
                column: "LastModifierId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStockMovementHeaders_StockMovementNo",
                table: "AppStockMovementHeaders",
                column: "StockMovementNo",
                unique: true);
